...
public class OrderController {
    ...
    @GET
    @Path("/getOrderItemsWithProduct/{orderId}")
    public Response getOrderItemsWithProduct(@PathParam("orderId") Long orderId){
        return orderService.getOrderItemsWithProductByOrderId(orderId);
    }
    @DELETE
    @Path("/delete/{id}")
